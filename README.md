...
```bash
# Create database
createdb event_booking_database

# Verify
psql -l | grep event_booking_database
```
...
DB_HOST=localhost
DB_PORT=5432
DB_NAME=event_booking_database
DB_USER=postgres
...
```json
{
  ...
  "data": {
    ...
    "status": "confirmed",
    "position": null,
    "bookedAt": "2024-11-27T10:05:00.000Z",
    "createdAt": "2024-11-27T10:05:00.000Z",
    "updatedAt": "2024-11-27T10:05:00.000Z"
  }
}
```
...
```json
{
  ...
  "data": {
    ...
    "status": "waiting",
    "position": 5,
    "bookedAt": "2024-11-27T10:06:00.000Z",
    "createdAt": "2024-11-27T10:06:00.000Z",
    "updatedAt": "2024-11-27T10:06:00.000Z"
  }
}
```
...
```json
{
  ...
  "data": {
    "cancelledBooking": {
      ...
      "userId": "user-john-doe",
      "status": "cancelled",
      "updatedAt": "2024-11-27T10:10:00.000Z"
    },
    "assignedUser": null
  }
}
...
```json
{
  ...
  "data": {
    ...
    "bookedTickets": 250,
    "waitingListCount": 15,
    "timestamp": "2024-11-27T10:15:30.000Z"
  }
}
```
